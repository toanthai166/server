...
router.route('/').get(validate(faqValidation.getFAQs), faqController.getFAQs);
...
router
  .route('/:faqId/active')
  .patch(auth('faq'), validate(faqValidation.changeIsActiveFAQ), faqController.changeIsActiveFAQ);
